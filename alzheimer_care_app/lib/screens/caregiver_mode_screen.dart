...
class _CaregiverModeScreenState extends State<CaregiverModeScreen> {
  ...
  void _showSimpleSettings(BuildContext context) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Column(
            ...
            children: [
              ...
              Text('개발자: UNITHON 팀'),
              SizedBox(height: 16),
              Text('이 앱은 알츠하이머 환자와 보호자를 위한 케어 앱입니다.'),
            ],
          ),
          actions: [
            TextButton(
                  ...
                  child: ListView(
                    children: [
                      ...
                      _buildOptionItem(
                        ...
                        () => Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) => const BehaviorAnalysisScreen(),
                          ),
                        ),
                      ),
                      _buildOptionItem(
